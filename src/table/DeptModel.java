...
//View 인 Jtable을 데이터와 분리시켜주는 객체인 TableModel인터페이스를 구현한 
//AbstractTableModel을 재정의 해보자!!
public class DeptModel extends AbstractTableModel{
	/*
	 *  아래의 재정의 메서드들을 필요로 하고, 호출하는 주체는 바로 JTable이다
	 * */
	//우리대신 디비 접속을 대행할 클래스를 보유한다!!
	...
	public DeptModel() {
		...
		//접속 후 커넥션 객체를 반환받자!! why? 아래의 pstmt의 인스턴스를 얻기 위해..
	...
	@Override
	public Object getValueAt(int row, int col) { //칸수만큼 호출
